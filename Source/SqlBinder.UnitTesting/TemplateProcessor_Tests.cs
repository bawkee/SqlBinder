    ...
    public partial class SqlBinder_Tests
    {
        ...
        public class TemplateProcessor_Tests
        {
            ...
            public void Junk_Scopes()
            {
                ...
                AssertCommand(new MockQuery(_connection, "SELECT * FROM TABLE1 {JUNK ON THE RIGHT {NESTED JUNK}}")
                    .CreateCommand());
                AssertCommand(new MockQuery(_connection, "{JUNK ON THE LEFT} SELECT * FROM TABLE1").CreateCommand());
                AssertCommand(new MockQuery(_connection, "{} SELECT {}* FROM TABLE1 {}").CreateCommand());
                AssertCommand(new MockQuery(_connection, "SELECT{} * FROM TABLE1").CreateCommand());
                AssertCommand(new MockQuery(_connection,
                ...
                AssertCommand(new MockQuery(_connection,
                    ...
                    .CreateCommand());
                AssertCommand(new MockQuery(_connection,
                    "{JUNK: ~!@#$%^&*()_+~<>?,./;:}SELECT * FROM TABLE1 {JUNK ON THE RIGHT}").CreateCommand());
            }
            ...
            public void Junk_Scopes_With_Sql_Comments()
            {
                ...
                AssertCommand(new MockQuery(_connection, "/* Test comment */SELECT * FROM TABLE1 {JUNK ON THE RIGHT}")
                    .CreateCommand());
                AssertCommand(new MockQuery(_connection,
                ...
                AssertCommand(new MockQuery(_connection,
                    ...
                    .CreateCommand());
                AssertCommand(new MockQuery(_connection,
                        "{JUNK ON THE LEFT} /* Test comment */SELECT * {/* Test comment */JUNK ON THE MIDDLE/* Test comment */}FROM TABLE1 {JUNK ON THE RIGHT {NESTED JUNK}}")
                    .CreateCommand());
            }
            ...
            public void Junk_Scopes_With_SqlBinder_Comments()
            {
                ...
                AssertCommand(new MockQuery(_connection,
                    ...
                    .CreateCommand());
                AssertCommand(new MockQuery(_connection,
                        "/*{ Test comment {Curly braces junk} }*/{JUNK ON THE LEFT {NESTED JUNK}} SELECT * FROM TABLE1 {JUNK ON THE RIGHT {NESTED JUNK}}")
                    .CreateCommand());
                AssertCommand(new MockQuery(_connection,
            ...
            public void Junk_Scopes_With_Parameters()
            {
                AssertCommand(new MockQuery(_connection, "SELECT * FROM TABLE1 {JUNK ON THE RIGHT}").CreateCommand());
                AssertCommand(new MockQuery(_connection,
                    "SELECT * FROM TABLE1 {JUNK ON THE RIGHT {NESTED JUNK [criteria1]}}").CreateCommand());
                AssertCommand(new MockQuery(_connection, "{JUNK ON THE LEFT} SELECT * FROM TABLE1").CreateCommand());
                AssertCommand(new MockQuery(_connection,
            ...
            {
                var sql =
                    "SELECT * FROM TABLE1 WHERE COLUMN1 = 'This is some {literal text} that includes @{special characters} like [this] or [[this]] or \"{ this maybe }\".'";
            ...
            public void Basic_Comments()
            {
                ...
                var sql =
                    "SELECT * FROM TABLE1 WHERE COLUMN1 = 123 /* This \"comment\" 'should' include {this scope} or [this]. */";
                AssertCommand(new MockQuery(_connection, sql).CreateCommand(), sql);
            }
            ...
            public void Escape_Strings()
            {
                ...
                var sql =
                    "SELECT * FROM TABLE1 {WHERE {[[Some Column 1]] [SomeCriteria1]} {[[Some Column 2]] [SomeCriteria2]} {[[Some Column 3]] [SomeCriteria3]}}";
                var expected =
                    "SELECT * FROM TABLE1 WHERE [Some Column 1] = :pSomeCriteria1_1 AND [Some Column 3] = :pSomeCriteria3_1";
            ...
            {
                var query = new Query(
                    "SELECT * FROM TABLE1 {WHERE {COLUMN1 :Criteria1} {COLUMN2 :Criteria2} {COLUMN3 :Criteria3} " +
            ...
            public void Separators_Handling()
            {
                ...
                query.SetCondition("Criteria1", true);
                query.SetCondition("Criteria2", true);
                Assert.AreEqual("SELECT * FROM TABLE1 WHERE COLUMN1 = :pCriteria1_1 AND COLUMN2 = :pCriteria2_1",
                    query.GetSql());

                query.Conditions.Clear();
                query.SetCondition("Criteria2", true);
                query.SetCondition("Criteria3", true);
                Assert.AreEqual("SELECT * FROM TABLE1 WHERE COLUMN2 = :pCriteria2_1 AND COLUMN3 = :pCriteria3_1",
                    query.GetSql());
                ...
                query.SetCondition("Criteria3", true);
                Assert.AreEqual(
                    "SELECT * FROM TABLE1 WHERE COLUMN1 = :pCriteria1_1 AND COLUMN2 = :pCriteria2_1 AND COLUMN3 = :pCriteria3_1",
                    query.GetSql());

                query.Conditions.Clear();
                query.SetCondition("Criteria1", true);
                query.SetCondition("Criteria3", true);
                Assert.AreEqual("SELECT * FROM TABLE1 WHERE COLUMN1 = :pCriteria1_1 AND COLUMN3 = :pCriteria3_1",
                    query.GetSql());
            }
            ...
            public void Separators_Blanks()
            {
                ...
                query.SetCondition("Criteria1", true);
                query.SetCondition("Criteria2", true);
                Assert.AreEqual("SELECT * FROM TABLE1 WHERE COLUMN1 = :pCriteria1_1 COLUMN2 = :pCriteria2_1",
                    query.GetSql());
                ...
                query.SetCondition("Criteria3", true);
                Assert.AreEqual(
                    "SELECT * FROM TABLE1 WHERE COLUMN1 = :pCriteria1_1 COLUMN2 = :pCriteria2_1 AND COLUMN3 = :pCriteria3_1",
                    query.GetSql());
            ...
            {
                var query = new Query(
                    "SELECT * FROM TABLE1 {WHERE {COLUMN1 :Criteria1} @{{COLUMN2 :Criteria2} {COLUMN3 :Criteria3}} {COLUMN4 :Criteria4}}");
                ...
                query.SetCondition("Criteria1", true);
                query.SetCondition("Criteria4", true);
                Assert.AreEqual("SELECT * FROM TABLE1 WHERE COLUMN1 = :pCriteria1_1 AND COLUMN4 = :pCriteria4_1",
                    query.GetSql());

                query.Conditions.Clear();
                query.SetCondition("Criteria2", true);
                query.SetCondition("Criteria3", true);
                Assert.AreEqual("SELECT * FROM TABLE1 WHERE COLUMN2 = :pCriteria2_1 OR COLUMN3 = :pCriteria3_1",
                    query.GetSql());

                query.Conditions.Clear();
                query.SetCondition("Criteria2", true);
                query.SetCondition("Criteria4", true);
                Assert.AreEqual("SELECT * FROM TABLE1 WHERE COLUMN2 = :pCriteria2_1 AND COLUMN4 = :pCriteria4_1",
                    query.GetSql());

                query.Conditions.Clear();
                query.SetCondition("Criteria3", true);
                query.SetCondition("Criteria4", true);
                Assert.AreEqual("SELECT * FROM TABLE1 WHERE COLUMN3 = :pCriteria3_1 AND COLUMN4 = :pCriteria4_1",
                    query.GetSql());
                ...
                query.SetCondition("Criteria3", true);
                Assert.AreEqual(
                    "SELECT * FROM TABLE1 WHERE COLUMN1 = :pCriteria1_1 AND COLUMN2 = :pCriteria2_1 OR COLUMN3 = :pCriteria3_1",
                    query.GetSql());
                ...
                query.SetCondition("Criteria4", true);
                Assert.AreEqual(
                    "SELECT * FROM TABLE1 WHERE COLUMN2 = :pCriteria2_1 OR COLUMN3 = :pCriteria3_1 AND COLUMN4 = :pCriteria4_1",
                    query.GetSql());
                ...
                query.SetCondition("Criteria4", true);
                Assert.AreEqual(
                    "SELECT * FROM TABLE1 WHERE COLUMN1 = :pCriteria1_1 AND COLUMN2 = :pCriteria2_1 OR COLUMN3 = :pCriteria3_1 AND COLUMN4 = :pCriteria4_1",
                    query.GetSql());
            }
            ...
            {
                var query = new Query(
                    "SELECT * FROM TABLE1 {WHERE {COLUMN1 :Variable1} +{COLUMN2 :Variable2} +{COLUMN3 :Variable3} {COLUMN4 :Criteria4}}");
                ...
                query.DefineVariable("Variable2", "= test2");
                query.DefineVariable("Variable3", "= test3");
                Assert.AreEqual("SELECT * FROM TABLE1 WHERE COLUMN1 = test1 COLUMN2 = test2 COLUMN3 = test3",
                    query.GetSql());
                ...
                query.DefineVariable("Variable1", "= test1");
                query.SetCondition("Criteria4", true);
                Assert.AreEqual("SELECT * FROM TABLE1 WHERE COLUMN1 = test1 AND COLUMN4 = :pCriteria4_1",
                    query.GetSql());
                ...
                query.DefineVariable("Variable2", "= test2");
                query.SetCondition("Criteria4", true);
                Assert.AreEqual("SELECT * FROM TABLE1 WHERE COLUMN2 = test2 AND COLUMN4 = :pCriteria4_1",
                    query.GetSql());

                // Test a typical ORDER BY scenario

                query = new Query(
                    "SELECT * FROM TABLE1 {WHERE {COLUMN1 :Criteria1} {COLUMN2 :Criteria2}} +{ORDER BY :ordering}");
                ...
                query.SetCondition("Criteria2", true);
                query.DefineVariable("ordering", "COLUMN1 DESC");
                Assert.AreEqual("SELECT * FROM TABLE1 WHERE COLUMN2 = :pCriteria2_1 ORDER BY COLUMN1 DESC",
                    query.GetSql());
                ...
                Assert.AreEqual(
                    "SELECT * FROM TABLE1 WHERE COLUMN1 = :pCriteria1_1 AND COLUMN2 = :pCriteria2_1 ORDER BY COLUMN2 DESC",
                    query.GetSql());
            }
