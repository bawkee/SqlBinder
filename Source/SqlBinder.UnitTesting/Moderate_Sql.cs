        ...
        public class Moderate_Sql
        {
            ...
            public void Common_Sql_2()
            {
                var query = new MockQuery(_connection,
                    "SELECT * FROM TABLE1 {WHERE {JUNK 1} {COLUMN1 [Criteria1]} {JUNK 2}}");
            ...
            {
                var query = new MockQuery(_connection,
                    "SELECT * FROM TABLE1 {WHERE {COLUMN1 :Criteria1} {COLUMN2 :Criteria2}}");
            ...
            {
                var query = new MockQuery(_connection,
                    "SELECT * FROM TABLE1 {WHERE {COLUMN1 [Criteria1]} {JUNK 1} {COLUMN2 [Criteria2]}} {JUNK 2}");
            ...
            public void Join_Sql_1()
            {
                ...
                Assert.AreEqual(DateTime.Parse("11/1/1995", System.Globalization.CultureInfo.InvariantCulture),
            ...
            public void Empty_String_Sql()
            {
                ...
                AssertCommand(cmd);
                Assert.AreEqual("SELECT * FROM TABLE1 WHERE COLUMN1 IN (:pCriteria1_1, :pCriteria1_2, :pCriteria1_3)",
                    cmd.CommandText);
                Assert.AreEqual(3, cmd.Parameters.Count);
