    ...
    public partial class SqlBinder_Tests
    {
        ...
        public class Complex_Sql
        {
            ...
            public void Complex_Sql_3()
            {
                ...
                Assert.AreEqual(DateTime.Parse("12/30/1995", System.Globalization.CultureInfo.InvariantCulture),
                    cmd.Parameters[0].Value);
                Assert.AreEqual(DateTime.Parse("9/1/1995", System.Globalization.CultureInfo.InvariantCulture),
                    cmd.Parameters[1].Value);
                Assert.AreEqual(DateTime.Parse("11/30/1995", System.Globalization.CultureInfo.InvariantCulture),
            ...
            public void Complex_Sql_4()
            {
                ...
                _query.SetCondition("OrderDate",
                    DateTime.Parse("12/30/1995", System.Globalization.CultureInfo.InvariantCulture),
                    NumericOperator.IsLessThanOrEqualTo);
                ...
                Assert.AreEqual(DateTime.Parse("12/30/1995", System.Globalization.CultureInfo.InvariantCulture),
                    cmd.Parameters[0].Value);
                Assert.AreEqual(DateTime.Parse("11/20/1995", System.Globalization.CultureInfo.InvariantCulture),
                    cmd.Parameters[1].Value);
                Assert.AreEqual(DateTime.Parse("11/21/1995", System.Globalization.CultureInfo.InvariantCulture),
                    cmd.Parameters[2].Value);
                Assert.AreEqual(DateTime.Parse("11/25/1995", System.Globalization.CultureInfo.InvariantCulture),
