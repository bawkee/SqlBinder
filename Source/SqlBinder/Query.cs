...
namespace SqlBinder
{
	...
	public class Query
	{
		...
		/// <summary>
		/// Gets a list of errors that were generated by the parser engine after calling <see cref="GetSql"/> method.
		/// </summary>
		public string ParserErrors { get; private set; }

		/// <summary>
		/// Gets a list of warnings that were generated by the parser engine after calling <see cref="GetSql"/> method.
		/// </summary>
